...
// ─── Тактовий сигнал 2 Гц (Timer5 CTC, OC5A) ────────────────────────────────
#define CLK2HZ_PIN   46  // апаратний вихід 2 Гц, OC5A (Timer5 CTC toggle)
#define CLK_ECHO_IN  34  // вхід зовнішнього цифрового сигналу
#define CLK_ECHO_OUT 35  // вихід-дублікат вхідного сигналу
